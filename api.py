...
@endpoints.api(name="graderecorder", 
               ...
               hostname="kenji-grade-recorder-oathu.appspot.com",
...
class GradeRecorderApi(protorpc.remote.Service):
    ...
    @Student.query_method(user_required="True", 
    ...
    @Assignment.query_method(user_required="True", 
                             query_fields=("limit","pageToken"),
    ...
    @GradeEntry.query_method(user_required="True", 
                             query_fields=("limit","order","pageToken","assignment_key"),
                             name="gradeentry.list", 
                             path="gradeentry/list/{assignment_key}", 
                             http_method="GET")
    ...
    @GradeEntry.method(user_required="True", 
                       name="gradeentry.insert", 
                       path="gradeentry/insert", 
                       http_method="POST")
